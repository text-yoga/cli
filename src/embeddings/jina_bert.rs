...
use candle_transformers::models::with_tracing::{linear, linear_no_bias, Embedding, Linear};
...
impl BertEmbeddings {
    fn new(vb: VarBuilder, cfg: &Config) -> Result<Self> {
        let new_span = tracing::span!(tracing::Level::TRACE, "new embeddings");
        let _s = new_span.enter();
        event!(Level::INFO, "Creating BertEmbedding");
        let word_embeddings =
...
impl BertSelfAttention {
    fn new(vb: VarBuilder, cfg: &Config) -> Result<Self> {
        let new_span = tracing::span!(tracing::Level::TRACE, "self-attn");
        let _s = new_span.enter();
...
impl BertSelfOutput {
    fn new(vb: VarBuilder, cfg: &Config) -> Result<Self> {
        let new_span = tracing::span!(tracing::Level::TRACE, "self-out");
        let _s = new_span.enter();
...
impl BertAttention {
    fn new(vb: VarBuilder, cfg: &Config) -> Result<Self> {
        let new_span = tracing::span!(tracing::Level::TRACE, "new attn");
        let _s = new_span.enter();
...
impl BertLayer {
    fn new(vb: VarBuilder, cfg: &Config) -> Result<Self> {
        let new_span = tracing::span!(tracing::Level::TRACE, "new layer");
        let _s = new_span.enter();
        event!(Level::INFO, "Creating BertLayer");
...
impl BertEncoder {
    fn new(vb: VarBuilder, cfg: &Config) -> Result<Self> {
        let new_span = tracing::span!(tracing::Level::TRACE, "new encoder");
        let _s = new_span.enter();
        event!(Level::INFO, "Creating BertEncoder");
...
impl BertModel {
    pub fn new(vb: VarBuilder, cfg: &Config) -> Result<Self> {
        let new_span = tracing::span!(tracing::Level::TRACE, "new model");
        let _s = new_span.enter();
        event!(Level::INFO, "Creating BertModel");
